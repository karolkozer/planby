...
| `grid layout`            | `object`  | optional | Background grid on the layout. Mode hoverHighlight values: `true/false`, onGridItemClick: function with all the properties on clicked item grid [Read more](#grid)                                                             | `PRO`  |
